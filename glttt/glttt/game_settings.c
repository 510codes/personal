...
const GLdouble ROTATE_FACTOR = GLTTT_ROTATE_FACTOR_DEFAULT;
const GLdouble MOUSE_ROT_FACT = GLTTT_MOUSE_ROT_FACT_DEFAULT;
const GLdouble MOUSE_ZOOM_FACT = GLTTT_MOUSE_ZOOM_FACT_DEFAULT;

const GLint PEG_SIZE = GLTTT_PEG_SIZE_DEFAULT;
const GLint PEG_THICK = GLTTT_PEG_THICK_DEFAULT;

const GLdouble PEG_SELECT_DIST = GLTTT_PEG_SELECT_DIST_DEFAULT;
...
const GLdouble PEG_LETTER_POS[][2] = GLTTT_PEG_LETTER_POS_DEFAULT;
								

const GLdouble PEG_POS[][2] = GLTTT_PEG_POS_DEFAULT;


const peg_label_t PEG_ROW[][3] = GLTTT_PEG_ROW_DEFAULT;

const GLdouble COLOUR_WHITE[] = GLTTT_COLOUR_WHITE_DEFAULT;
const GLdouble COLOUR_RED[] = GLTTT_COLOUR_RED_DEFAULT;

GLdouble COLOUR_MSG_BOX[] = GLTTT_COLOUR_MSG_BOX_DEFAULT;
GLdouble COLOUR_MSG_TEXT[] = GLTTT_COLOUR_MSG_TEXT_DEFAULT;
GLdouble COLOUR_VERSION_STRING[] = GLTTT_COLOUR_VERSION_STRING_DEFAULT;

GLdouble COLOUR_MSG_BACK[] = GLTTT_COLOUR_MSG_BACK_DEFAULT;
